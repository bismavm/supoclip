      ...
      >
        ...
        >
          <div
            style={{
              ...
              height: 88,
              borderRadius: 20,
              background: "linear-gradient(135deg, #b63a3f 0%, #9f2f34 100%)",
              boxShadow: "0 8px 32px rgba(182,58,63,0.24), 0 2px 8px rgba(159,47,52,0.15)",
            }}
          >
            <svg
              width="48"
          ...
          >
            Turn long videos into high-performing shorts
          </div>
          ...
          >
            {["AI-Powered", "Auto Subtitles", "9:16 Vertical", "Team Workflow"].map(
              (label) => (
                <div
                  key={label}
                  style={{
                    ...
                    padding: "8px 18px",
                    borderRadius: 100,
                    background: "rgba(182,58,63,0.08)",
                    border: "1px solid rgba(182,58,63,0.2)",
                    fontFamily: "Geist",
                    fontSize: 15,
                    color: "#5d3f3d",
                    letterSpacing: "-0.2px",
        ...
        <div
          style={{
            ...
            right: 0,
            height: 4,
            background: "linear-gradient(90deg, #b63a3f 0%, #d47f78 50%, #b63a3f 100%)",
            display: "flex",
          }}
        />
      </div>
