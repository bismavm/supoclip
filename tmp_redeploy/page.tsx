...
> = {
  ...
  cancelled: {
    ...
    bgClass: "bg-rose-100 border-rose-200/60",
...
export default function ListPage() {
    ...
    return (
      <div className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-4 py-24 text-center">
          <h1 className="text-3xl font-bold text-rose-900 mb-4">Sign In Required</h1>
  ...
  return (
    <div className="min-h-screen bg-rose-50/50">
      {/* ── Page header ──────────────────────────────────────── */}
      <div className="border-b border-rose-200 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-5">
          <div className="flex items-center gap-3 mb-4">
            <Link href="/">
              <Button variant="ghost" size="sm" className="text-rose-500 hover:text-rose-900">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h1 className="font-[var(--font-syne)] text-2xl font-bold tracking-tight text-rose-950">
                Generations
              </h1>
        ...
        {isLoading ? (
          <div className="space-y-3">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="flex items-center gap-4 rounded-xl border border-rose-200 bg-white p-4"
              >
          ...
          <Card className="border-rose-200">
            <CardContent className="p-12 text-center">
              ...
              <h2 className="text-xl font-semibold text-rose-950 mb-2">No generations yet</h2>
          ...
          <>
            ...
            <div className="mb-2 flex items-center gap-4 px-4 py-2">
              <Checkbox
                ...
                className="data-[state=indeterminate]:bg-rose-400 data-[state=indeterminate]:border-rose-400"
              />
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "border-rose-900/20 bg-rose-50 shadow-sm ring-1 ring-rose-900/5"
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        isSelected ? "bg-rose-900" : "bg-transparent",
                      )}
                    />
                    ...
                    <Link href={`/tasks/${task.id}`} className="flex-1 min-w-0">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <div className="min-w-0">
                          <h3 className="truncate text-sm font-semibold text-rose-950 transition-colors group-hover:text-rose-600">
                            {task.source_title}
                          </h3>
                          <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-rose-400">
                            <span className="uppercase tracking-wide font-medium text-rose-500">
                              {task.source_type}
                            </span>
      ...
      {selectedCount > 0 && (
        ...
        >
          <div
            className="pointer-events-auto flex items-center gap-1 rounded-2xl border border-rose-800 bg-rose-950 px-2 py-2 shadow-2xl"
          ...
          >
            ...
            <div className="flex items-center gap-2.5 pl-2 pr-3">
              <Checkbox
                ...
                className="border-rose-600 data-[state=checked]:bg-white data-[state=checked]:text-rose-950 data-[state=checked]:border-white data-[state=indeterminate]:bg-rose-500 data-[state=indeterminate]:border-rose-500"
              />
            ...
            <Separator orientation="vertical" className="h-6 bg-rose-700" />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="text-rose-300 hover:text-white hover:bg-rose-800 disabled:text-rose-600 disabled:hover:bg-transparent"
                  >
                    ...
                    {cancelableCount > 0 && (
                      <span className="text-xs text-rose-500">{cancelableCount}</span>
                    )}
                  </Button>
                </TooltipTrigger>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    {resumableCount > 0 && (
                      <span className="text-xs text-rose-500">{resumableCount}</span>
                    )}
                  </Button>
                </TooltipTrigger>
                <TooltipContent side="top" sideOffset={8}>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="text-red-400 hover:text-red-300 hover:bg-red-950/50 disabled:text-rose-600 disabled:hover:bg-transparent"
                  >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  disabled={activeBatchAction !== null}
                  className="text-rose-400 hover:text-white hover:bg-rose-800 rounded-xl"
