...
CAPTION_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "animation": "none",
        "shadow": False,
        "position_y": 0.75,  # 75% down the video (middle position)
    },
    "hormozi": {
        "name": "Hormozi",
        ...
        "animation": "karaoke",
        "shadow": True,
        "position_y": 0.75,  # Middle position
    },
    "mrbeast": {
        "name": "MrBeast",
    ...
    "minimal": {
        ...
        "animation": "fade",
        "shadow": False,
        "position_y": 0.80,  # Lower position for subtler look
    },
    "tiktok": {
        "name": "TikTok",
    ...
    "podcast": {
        ...
        "animation": "fade",
        "shadow": False,
        "position_y": 0.78,  # Slightly lower position
    },
}
